...
const esnext_server_extras_1 = require("esnext-server-extras");
 ...
 * @param config
 */
exports.useWebModules = esnext_server_extras_1.memoize((config = loadWebModulesConfig()) => {
    const outDir = path_1.default.join(config.rootDir, "web_modules");
    if (config.clean && fs_1.existsSync(outDir)) {
        ...
        try {
            ...
            for (const [key, pathname] of Object.entries(importMap.imports)) {
                try {
                    ...
                    tiny_node_logger_1.default.info("web_module:", chalk_1.default.green(key), "->", chalk_1.default.gray(pathname));
                }
                catch (e) {
                    tiny_node_logger_1.default.warn("not found:", chalk_1.default.blue(key), "->", chalk_1.default.red(pathname));
    ...
    const rollupPlugins = [
        rollup_plugin_dummy_module_1.rollupPluginDummyModule(config),
        rollup_plugin_rewrite_imports_1.rollupPluginRewriteImports({ importMap, resolver: resolveImport, squash }),
